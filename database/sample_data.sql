...
-- Library Branches (id, name, location, contact_info)
...
-- Authors (id, name, biography, nationality, birth_date)
...
-- Books (isbn, title, publication_year, category_id, status)
...
('9780140449105', 'Principia Mathematica', 1687, 3, 'Under Maintenance');

-- Book Authors (book_isbn, author_id)
...
-- Members (id, type, name, email, phone, expiry_date, unpaid_fees)
...
-- Inventory (book_isbn, branch_id, total_copies, available_copies)
...
-- Borrow Records (id, member_id, book_isbn, branch_id, borrow_date, due_date, return_date, late_fee)
